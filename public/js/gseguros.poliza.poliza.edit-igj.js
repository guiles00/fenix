...
//calcula importe - plus - premio asegurado
			...
			// Guardar poliza
			$('#save_poliza_igj').click(function() {
				
				//if(!$("#poliza_poliza_igj").valid())return false;	 
								...
								var data = $('#poliza_poliza_igj').serializeArray();
							 //console.debug(data);

								$.ajax({
											url : "./poliza/poliza/edit-poliza-igj",
											data : data,
			...
			// Anular poliza
			$('#anular_poliza_igj').click(function() {
...
//validar formulario de alta poliza
			...
			$('#enviar_compania_poliza_igj').click(function() {
				...
				$.ajax({
					url : "./poliza/poliza/enviar-poliza-compania-igj",
					data : {
						poliza_id : poliza_id
					},
					success : function(result) {
