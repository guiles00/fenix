...
//calcula importe - plus - premio asegurado
			...
			$('#save_poliza_transporte_mercaderia').click(function() {
				...
				//if(!$("#poliza_poliza_transporte_mercaderia").valid())return false;	 
							 ...
							 //console.debug(data);
								...
								$.ajax({
											url : "./poliza/poliza/edit-poliza-transporte-mercaderia",
											data : data,
			...
			// Anular poliza
			$('#anular_poliza_transporte_mercaderia').click(function() {
...
//validar formulario de alta poliza
			$("#poliza_poliza_transporte_mercaderia").validate({
			    rules: {
			        asegurado: {
			            required: true
			        }
			...
			$('#enviar_compania_poliza_transporte_mercaderia').click(function() {
				...
				$.ajax({
					url : "./poliza/poliza/enviar-poliza-compania-transporte_mercaderia",
					data : {
						poliza_id : poliza_id
					},
					success : function(result) {
