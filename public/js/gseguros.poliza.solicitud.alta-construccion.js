$(document).ready(
		function() {
			...
			$('#datos_seguro_construccion_show').click(function() {
				$('#datos_seguro').toggle();
			});
			$('#detalle_riesgo_construccion_show').click(function() {
				$('#detalle_riesgo').toggle();
			});
			$('#datos_solicitud_construccion_show').click(function() {
				$('#datos_solicitud').toggle();
			});
			...
			$('#valor_cuota_construccion')
					.change(
							function() {

								var s_cuotas = $('#cuotas_construccion'),
								s_valor_cuota = $('#valor_cuota_construccion');
								var importe=0;
								var cuotas=0;
								var valor_cuota = 0;
								...
								if ((cuotas != 0 && valor_cuota != 0)) {
									...
									$('#importe_construccion').val(importe);
								}
		 ...
		 $('#fecha_pedido_agente').val(date_today);
			...
			// Guardar Solicitud
			$('#save_solicitud_construccion').click(function() {
				
				if(!$("#solicitud_poliza_construccion").valid())return false;	 
								...
								var data = $('#solicitud_poliza_construccion').serializeArray();
								// console.debug(data);

								$.ajax({
											url : "./poliza/solicitud/alta-construccion",
											data : data,
			...
			// Aprobar Solicitud
			$('#aprobar_solicitud_construccion').click(function() {
			...
			// Confirmar Solicitud
			$('#confirmar_solicitud_construccion').click(function() {
			...
			// Anular Solicitud
			$('#anular_solicitud_construccion').click(function() {
...
//validar formulario de alta solicitud
			$("#solicitud_poliza_construccion").validate({
			    rules: {
			        asegurado: {
			            required: true
			        }
			...
			$('#enviar_compania_solicitud_construccion').click(function() {
				...
				$.ajax({
					url : "./poliza/solicitud/enviar-solicitud-compania-construccion",
					data : {
						solicitud_id : solicitud_id
					},
					success : function(result) {
