$(document).ready(
		function() {
			...
			$('#fecha_vigencia_poliza_incendio').datepicker(
					{
						dateFormat : 'yy-mm-dd',
...
//calcula importe - plus - premio asegurado
			...
			$('#save_poliza_incendio').click(function() {
								...
								var data = $('#poliza_poliza_incendio').serializeArray();
							
								$.ajax({
											url : "./poliza/poliza/view-poliza-incendio",
											data : data,
