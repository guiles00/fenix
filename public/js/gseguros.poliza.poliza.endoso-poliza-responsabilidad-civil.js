//gseguros.poliza.poliza.endoso-poliza-responsabilidad_civil.js
$(document).ready(
		function() {
			function confirmar() {
...
//calcula importe - plus - premio asegurado
			...
			.change(
					function() {
						...
						s_importe = $('#importe_responsabilidad_civil_endoso');
			...
			$('#valor_cuota_responsabilidad_civil_endoso')
					.change(
							function() {

								var s_cuotas = $('#cuotas_responsabilidad_civil_endoso'),
								s_valor_cuota = $('#valor_cuota_responsabilidad_civil_endoso');
								var importe=0;
								var cuotas=0;
								var valor_cuota = 0;
								...
								if ((cuotas != 0 && valor_cuota != 0)) {
									...
									$('#importe_responsabilidad_civil_endoso').val(importe);
								}

							});

			$('#cuotas_responsabilidad_civil_endoso')
					.change(
							function() {
			...
			// Guardar Solicitud
			$('#save_endoso_poliza_responsabilidad_civil').click(function() {
								...
								var data = $('#endoso_poliza_responsabilidad_civil').serializeArray();
								// console.debug(data);

								$.ajax({
											url : "./poliza/poliza/endoso-poliza-responsabilidad-civil",
											data : data,
			...
			$('#confirmar_solicitud_aduanero').click(function() {
				...
				var importe_responsabilidad_civil = $('#importe_responsabilidad_civil').val();
				if(importe_responsabilidad_civil <= 0 ){
			...
			$('#enviar_compania_endoso_poliza_responsabilidad_civil').click(function() {
				...
				$.ajax({
					url : "./poliza/poliza/enviar-solicitud-endoso-compania-responsabilidad_civil",
					data : {
						poliza_id : poliza_id
					},
					success : function(result) {
