...
//calcula importe - plus - premio asegurado
			...
			// Guardar poliza
			$('#save_poliza_vida').click(function() {
				
				//if(!$("#poliza_poliza_vida").valid())return false;	 
								...
								var data = $('#poliza_poliza_vida').serializeArray();
							 //console.debug(data);

								$.ajax({
											url : "./poliza/poliza/edit-poliza-vida",
											data : data,
			...
			// Anular poliza
			$('#anular_poliza_vida').click(function() {
...
//validar formulario de alta poliza
			...
			$('#enviar_compania_poliza_vida').click(function() {
				...
				$.ajax({
					url : "./poliza/poliza/enviar-poliza-compania-vida",
					data : {
						poliza_id : poliza_id
					},
					success : function(result) {
