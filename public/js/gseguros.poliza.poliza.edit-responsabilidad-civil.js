...
//calcula importe - plus - premio asegurado
			...
			$('#save_poliza_responsabilidad_civil').click(function() {
				//if(!$("#poliza_poliza_responsabilidad_civil").valid())return false;	 
							 ...
							 //console.debug(data);
								...
								$.ajax({
											url : "./poliza/poliza/edit-poliza-responsabilidad-civil",
											data : data,
			...
			// Anular poliza
			$('#anular_poliza_responsabilidad_civil').click(function() {
...
//validar formulario de alta poliza
			$("#poliza_poliza_responsabilidad_civil").validate({
			    rules: {
			        asegurado: {
			            required: true
			        }
			...
			$('#enviar_compania_poliza_responsabilidad_civil').click(function() {
				...
				$.ajax({
					url : "./poliza/poliza/enviar-poliza-compania-responsabilidad_civil",
					data : {
						poliza_id : poliza_id
					},
					success : function(result) {
