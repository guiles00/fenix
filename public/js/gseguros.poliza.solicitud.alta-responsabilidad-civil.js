		 ...
		 $('#fecha_pedido_agente_responsabilidad_civil').val(date_today);
			...
			$('#save_solicitud_responsabilidad_civil').click(function() {
				...
				if(!$("#solicitud_poliza_responsabilidad_civil").valid())return false;	 
								...
								$.ajax({
											url : "./poliza/solicitud/alta-responsabilidad-civil",
											data : data,
			...
			$('#enviar_compania_solicitud_responsabilidad_civil').click(function() {
				...
				$.ajax({
					url : "./poliza/solicitud/enviar-solicitud-compania-responsabilidad-civil",
					data : {
						solicitud_id : solicitud_id
					},
					success : function(result) {
