...
//calcula importe - plus - premio asegurado
			...
			.change(
					function() {
						...
						var s_plus = $('#plus'),
						s_importe = $('#importe_integral_comercio');
			...
			$('#save_poliza_integral_comercio').click(function() {
				...
				//if(!$("#poliza_poliza_integral_comercio").valid())return false;	 
							 ...
							 //console.debug(data);
								...
								$.ajax({
											url : "./poliza/poliza/edit-poliza-integral-comercio",
											data : data,
			...
			// Anular poliza
			$('#anular_poliza_integral_comercio').click(function() {
...
//validar formulario de alta poliza
			$("#poliza_poliza_integral_comercio").validate({
			    rules: {
			        asegurado: {
			            required: true
			        }
			...
			$('#enviar_compania_poliza_integral_comercio').click(function() {
				...
				$.ajax({
					url : "./poliza/poliza/enviar-poliza-compania-integral_comercio",
					data : {
						poliza_id : poliza_id
					},
					success : function(result) {
