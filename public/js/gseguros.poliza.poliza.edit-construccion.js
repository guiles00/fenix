...
//calcula importe - plus - premio asegurado
			...
			.change(
					function() {
						...
						var s_plus = $('#plus'),
						s_importe = $('#importe_construccion');
			...
			// Guardar poliza
			$('#save_poliza_construccion').click(function() {
				
				//if(!$("#poliza_poliza_construccion").valid())return false;	 
								...
								var data = $('#poliza_poliza_construccion').serializeArray();
							 //console.debug(data);

								$.ajax({
											url : "./poliza/poliza/edit-poliza-construccion",
											data : data,
			...
			// Anular poliza
			$('#anular_poliza_construccion').click(function() {
...
//validar formulario de alta poliza
			$("#poliza_poliza_construccion").validate({
			    rules: {
			        asegurado: {
			            required: true
			        }
			...
			$('#enviar_compania_poliza_construccion').click(function() {
				...
				$.ajax({
					url : "./poliza/poliza/enviar-poliza-compania-construccion",
					data : {
						poliza_id : poliza_id
					},
					success : function(result) {
