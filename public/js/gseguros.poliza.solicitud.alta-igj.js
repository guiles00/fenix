$(document).ready(
		function() {
			...
			$('#datos_seguro_igj_show').click(function() {
				$('#datos_seguro').toggle();
			});
			$('#detalle_riesgo_igj_show').click(function() {
				$('#detalle_riesgo').toggle();
			});
			$('#datos_solicitud_igj_show').click(function() {
				$('#datos_solicitud').toggle();
			});
			...
			$('#valor_cuota_igj')
					.change(
							function() {
								...
								var s_cuotas = $('#cuotas_igj'),
								s_valor_cuota = $('#valor_cuota_igj');
								var importe=0;
								var cuotas=0;
								var valor_cuota = 0;
		 ...
		 $('#fecha_pedido_agente').val(date_today);
			...
			// Guardar Solicitud
			$('#save_solicitud_igj').click(function() {
				
				if(!$("#solicitud_poliza_igj").valid())return false;	 
								...
								var data = $('#solicitud_poliza_igj').serializeArray();
								// console.debug(data);

								$.ajax({
											url : "./poliza/solicitud/alta-igj",
											data : data,
			...
			// Aprobar Solicitud
			$('#aprobar_solicitud_igj').click(function() {
			...
			// Confirmar Solicitud
			$('#confirmar_solicitud_igj').click(function() {
				...
				var importe_igj = $('#importe_igj').val();
				if(importe_igj <= 0 ){
			...
			// Anular Solicitud
			$('#anular_solicitud_igj').click(function() {
...
//validar formulario de alta solicitud
			...
			$('#enviar_compania_solicitud_igj').click(function() {
				...
				$.ajax({
					url : "./poliza/solicitud/enviar-solicitud-compania-igj",
					data : {
						solicitud_id : solicitud_id
					},
					success : function(result) {
