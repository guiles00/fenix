...
//calcula importe - plus - premio asegurado
			...
			.change(
					function() {
						...
						var s_plus = $('#plus'),
						s_importe = $('#importe_seguro_tecnico');
			...
			$('#save_poliza_seguro_tecnico').click(function() {
				...
				//if(!$("#poliza_poliza_seguro_tecnico").valid())return false;	 
							 ...
							 //console.debug(data);
								...
								$.ajax({
											url : "./poliza/poliza/edit-poliza-seguro-tecnico",
											data : data,
			...
			// Anular poliza
			$('#anular_poliza_seguro_tecnico').click(function() {
...
//validar formulario de alta poliza
			$("#poliza_poliza_seguro_tecnico").validate({
			    rules: {
			        asegurado: {
			            required: true
			        }
			...
			$('#enviar_compania_poliza_seguro_tecnico').click(function() {
				...
				$.ajax({
					url : "./poliza/poliza/enviar-poliza-compania-seguro_tecnico",
					data : {
						poliza_id : poliza_id
					},
					success : function(result) {
