		 ...
		 $('#fecha_pedido_agente').val(date_today);
			...
			$('#save_solicitud_alquiler').click(function() {
				...
				if(!$("#solicitud_poliza_alquiler").valid())return false;	 
								...
								$.ajax({
											url : "./poliza/solicitud/alta-alquiler",
											data : data,
			...
			$('#confirmar_solicitud_alquiler').click(function() {
				...
				var importe_alquiler = $('#importe_alquiler').val();
				if(importe_alquiler <= 0 ){
					alert('No se puede crear la poliza - El importe debe ser mayor a cero!');
					return false;
				}
				//console.debug(importe_alquiler);
			...
			$('#enviar_compania_solicitud_alquiler').click(function() {
				...
				$.ajax({
					url : "./poliza/solicitud/enviar-solicitud-compania-alquiler",
					data : {
						solicitud_id : solicitud_id
					},
					success : function(result) {
