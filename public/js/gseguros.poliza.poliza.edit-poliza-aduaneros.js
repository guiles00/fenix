...
//calcula importe - plus - premio asegurado
			...
			// Guardar poliza
			$('#save_poliza_aduanero').click(function() {
				
				//if(!$("#poliza_poliza_aduanero").valid())return false;	 
								...
								var data = $('#poliza_poliza_aduanero').serializeArray();
							 //console.debug(data);

								$.ajax({
											url : "./poliza/poliza/edit-poliza-aduaneros",
											data : data,
			...
			// Anular poliza
			$('#anular_poliza_aduanero').click(function() {
...
//validar formulario de alta poliza
			$("#poliza_poliza_aduanero").validate({
			    rules: {
			        asegurado: {
			            required: true
			        }
			...
			$('#enviar_compania_poliza_aduaneros').click(function() {
				...
				$.ajax({
					url : "./poliza/poliza/enviar-poliza-compania-aduaneros",
					data : {
						poliza_id : poliza_id
					},
					success : function(result) {
