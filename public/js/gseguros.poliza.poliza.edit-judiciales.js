...
//calcula importe - plus - premio asegurado
			...
			// Guardar poliza
			$('#save_poliza_judiciales').click(function() {
				
				//if(!$("#poliza_poliza_judiciales").valid())return false;	 
								...
								var data = $('#poliza_poliza_judiciales').serializeArray();
							 //console.debug(data);

								$.ajax({
											url : "./poliza/poliza/edit-poliza-judiciales",
											data : data,
			...
			// Anular poliza
			$('#anular_poliza_judiciales').click(function() {
...
//validar formulario de alta poliza
			$("#poliza_poliza_judiciales").validate({
			    rules: {
			        asegurado: {
			            required: true
			        }
			...
			$('#enviar_compania_poliza_judiciales').click(function() {
				...
				$.ajax({
					url : "./poliza/poliza/enviar-poliza-compania-judiciales",
					data : {
						poliza_id : poliza_id
					},
					success : function(result) {
