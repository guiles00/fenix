<?php
abstract class Model_Base_DetalleIntegralComercio extends Doctrine_Record
{
	public function setTableDefinition()
	{
		$this->setTableName('detalle_integral_comercio');
		$this->hasColumn('detalle_integral_comercio_id', 'integer', 4, array(
             'type' => 'integer',
             'length' => '4',
             'primary' => true,
        	 'autoincrement' => true,
