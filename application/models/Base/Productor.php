...
abstract class Model_Base_Productor extends Doctrine_Record
{
	...
	$this->hasColumn('tipo_persona_id', 'integer', 4, array(
		...
		$this->hasColumn('ingresos_brutos', 'string', 255, array(
             'type' => 'string',
             'length' => '255',
             'fixed' => false,
             'notnull' => false,
		...
		$this->hasColumn('jubilacion', 'string', 255, array(
             'type' => 'string',
             'length' => '255',
             'fixed' => false,
             'notnull' => false,
		...
		$this->hasColumn('situacion_iva', 'string', 255, array(
             'type' => 'string',
             'length' => '255',
             'fixed' => false,
             'notnull' => false,
		...
		$this->hasColumn('situacion_juridica', 'string', 255, array(
             'type' => 'string',
             'length' => '255',
             'fixed' => false,
             'notnull' => false,
