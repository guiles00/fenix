<?php
abstract class Model_Base_DetalleSeguroTecnico extends Doctrine_Record
{
	public function setTableDefinition()
	{
		$this->setTableName('detalle_seguro_tecnico');
		$this->hasColumn('detalle_seguro_tecnico_id', 'integer', 4, array(
             'type' => 'integer',
             'length' => '4',
             'primary' => true,
        	 'autoincrement' => true,
