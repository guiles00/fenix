<?php
abstract class Model_Base_DetalleConstruccion extends Doctrine_Record
{
	public function setTableDefinition()
	{
		$this->setTableName('detalle_construccion');
		$this->hasColumn('detalle_construccion_id', 'integer', 4, array(
             'type' => 'integer',
             'length' => '4',
             'primary' => true,
        	 'autoincrement' => true,
