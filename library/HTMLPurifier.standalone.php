<?php
/**
 * SE DESHABILITO EL CACHE!!!, los archivos cache no deberian ser versionados y estar en carpetas temporales
 * */
...
if (!defined('HTMLPURIFIER_PREFIX')) {
    define('HTMLPURIFIER_PREFIX', dirname(__FILE__) . '/HTMLPurifier_standalone');
...
class HTMLPurifier_DefinitionCacheFactory
{
    ...
    public function create($type, $config) {
        $method = null;// deshabilito el cache! //$config->get('Cache.DefinitionImpl');
        if ($method === null) {
